 ...
 * @generated
 */
@Entity(id="entity:com.chinacreator.c2.omp.service.manage.workflowcommon.WebDisCategory",table="WORKFLOW_WEBDISPLAY_CATEGORY",ds="oracDB")
public class WebDisCategory implements Serializable{
	private static final long serialVersionUID = 1630871434133504L;				@Column(id="id_", type=ColumnType.uuid , datatype="string128"   )
	 ...
	 */
		...
		private java.lang.String url;
				...
				@Column(id="describe" , datatype="string512"   )
		private java.lang.String describe;
	
				@Column(id="remark1" , datatype="smallint"   )
