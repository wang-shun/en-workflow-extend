 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.c2.omp.service.manage.test.entity.test", table = "SERVICE_AGREEMENT", ds = "oracDB")
public class Test implements Serializable {
	private static final long serialVersionUID = 1537410595913728L;
	/**
	 *ID
	 */
