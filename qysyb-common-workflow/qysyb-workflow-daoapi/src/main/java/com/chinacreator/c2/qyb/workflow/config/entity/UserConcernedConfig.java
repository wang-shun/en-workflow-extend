package com.chinacreator.c2.qyb.workflow.config.entity;
 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.c2.qyb.workflow.config.entity.UserConcernedConfig", table = "WORKFLOW_USERCONCERNED_SETTING", ds = "oracDB")
