...
public class DateTimeUtils {
	...
	/**
	 * <code>DEFAULTFORMAT</code>opentsdb长日期格式
	 */
	public static final String  OPENTSDBDATEFORMAT = "yyyy/MM/dd-hh:mm:ss";
	/**
	 ...
	 * @param format
	 *            输出的格式
	 * @return 该日期对应月份的第一天日期
	 */
	public static String getFristDateOfMonth(Date date, String format) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
...
public static String getWeekOfDate(Date date) { 
  ...
  return weekDaysCode[intWeek]; 
	...
	public static void main(String[] args) {
		System.out.println(DateTimeUtils.dateToStr(DateTimeUtils.subtractMonth(
				DateTimeUtils.strToDate("2010-04-01", "yyyy-MM-dd"), 1),
				"yyyy-MM"));
	}
}
